# Hobbiton Shop OpenAPI Specification
[![Build Status](https://travis-ci.org/DominicGunn/hobbiton-shop-spec.svg?branch=master)](https://travis-ci.org/DominicGunn/hobbiton-shop-spec)
...
6. If you did everything correct, https://dominicgunn.github.io/hobbiton-shop-spec/ will lead to your new docs
...
- Documentation(ReDoc): https://dominicgunn.github.io/hobbiton-shop-spec/
- SwaggerUI: https://dominicgunn.github.io/hobbiton-shop-spec/swagger-ui/
- Look full spec:
    + JSON https://dominicgunn.github.io/hobbiton-shop-spec/swagger.json
    + YAML https://dominicgunn.github.io/hobbiton-shop-spec/swagger.yaml
- Preview spec version for branch `[branch]`: https://dominicgunn.github.io/hobbiton-shop-spec/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://dominicgunn.github.io/hobbiton-shop-spec/ with url from the message: `Server started <url>`
